...
pub fn cors_layer() -> CorsLayer {
    CorsLayer::new()
        ...
        .allow_headers([
            ...
            header::HeaderName::from_lowercase(b"x-datadog-parent-id").unwrap(),
            header::HeaderName::from_lowercase(b"x-datadog-trace-id").unwrap(),
            header::HeaderName::from_lowercase(b"x-datadog-sampling-priority").unwrap(),
            header::HeaderName::from_lowercase(b"x-datadog-origin").unwrap(),
        ])
